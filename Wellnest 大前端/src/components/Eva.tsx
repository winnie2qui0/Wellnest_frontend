...
Author: Lucas Quincoses Toledo (https://sketchfab.com/lucasquincoses)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/eve-wall-e-eva-5da3637249074ed79f44fd958889c2ac
Title: EVE (WALL-E) ~ EVA
*/
...
type GLTFResult = GLTF & {
  nodes: {
    ['0']: THREE.Mesh
    brain_lambert4_0: THREE.Mesh
    ['head_lambert2_u1_v-1_0']: THREE.Mesh
    head_lambert3_0: THREE.Mesh
    ['left_finger4_lambert1_u1_v-1_0']: THREE.Mesh
    ['body_lambert1_u1_v-1_0']: THREE.Mesh
    ['left_finger2_lambert1_u1_v-1_0']: THREE.Mesh
    ['right_finger3_lambert1_u1_v-1_0']: THREE.Mesh
    ['left_finger3_lambert1_u1_v-1_0']: THREE.Mesh
    ['left_finger1_lambert1_u1_v-1_0']: THREE.Mesh
    ['right_finger1_lambert1_u1_v-1_0']: THREE.Mesh
    ['right_finger2_lambert1_u1_v-1_0']: THREE.Mesh
    ['right_arm_lambert1_u1_v-1_0']: THREE.Mesh
    ['right_finger4_lambert1_u1_v-1_0']: THREE.Mesh
    ['left_arm_lambert1_u1_v-1_0']: THREE.Mesh
  }
  materials: {
    lambert5: THREE.MeshStandardMaterial
    lambert4: THREE.MeshStandardMaterial
    ['lambert2_u1_v-1']: THREE.MeshStandardMaterial
    lambert3: THREE.MeshStandardMaterial
    ['lambert1_u1_v-1']: THREE.MeshStandardMaterial
  }
}
...
export default function Eva(props: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group>(null)
  const { nodes, materials, animations } = useGLTF(require('../assets/models/eve_wall-e__eva.glb')) as GLTFResult
